...
#>
    ...
    foreach($WebName in $WebNames) {
        ...
        [PSCustomObject] @{
            ...
            Vulnerability = "V-76687, V-214404, V-76789, V-76791"
            SiteName = $WebName 
...
<#
.SYNOPSIS 
    Remove all *.jpp,*.java files for vulnerability 218801.
...
<#
.SYNOPSIS 
    Configure and verify Validation and Encryption properties for vulnerability 218807.
